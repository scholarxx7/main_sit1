...
app.get('/pages/blog.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../src/pages/blog.html'));
});

app.get('/pages/blog-post.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../src/pages/blog-post.html'));
});

app.get('/pages/course-detail.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../src/pages/course-detail.html'));
});
